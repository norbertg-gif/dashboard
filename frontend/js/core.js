...
let dashSettings = {
  ...
  build_rs_min_pp: -20.0,
  build_tranche_usd: 100,
  class_ratio_core: 4,
...
const _SETTINGS_INPUTS = [
  ...
  ['set-build-entry-atr-mult', 'build_entry_atr_mult'],
  ['set-build-rs-min-pp', 'build_rs_min_pp'],
  ['set-build-tranche-usd', 'build_tranche_usd'],
